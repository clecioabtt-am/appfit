const CACHE = 'afit-v1';
const ASSETS = ['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./assets/images/afit-logo.jpg','./assets/images/personal-afit.jpg','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
